# Oval App Store Submission Draft
...
- Bundle ID: `com.bradyvb.ovalapp`
- Audited production binary: `[PENDING NEW PRODUCTION BUILD]`
- Support URL: `https://www.theovalapp.com/support`
- Marketing URL: `https://www.theovalapp.com`
- Privacy URL: `https://www.theovalapp.com/privacy`
...
Oval helps eligible Ohio State community members find real plans, join small
...
Oval includes in-app reporting, blocking, account deletion, and privacy-data
...
Oval is for adults age 18 and older. It is not affiliated with or endorsed by
The Ohio State University.

## App Privacy Draft

Confirm these against the final App Store Connect wording. Oval does not use
third-party advertising and does not track users across other companies' apps or
websites.

| Apple category | Oval examples | Linked to user | Purpose |
| --- | --- | --- | --- |
...
| Identifiers | Oval user ID and push token | Yes | App functionality, notifications, security |
...
Oval is an 18+ social planning and club app for users with an eligible Ohio State
...
- Support: Settings > Contact support or `https://www.theovalapp.com/support`.

Location and notification permissions are optional. Users may enter meetup
locations manually. Oval verifies control of an eligible email address; it does
