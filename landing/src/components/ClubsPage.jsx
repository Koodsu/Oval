...
const OPERATOR_PILLARS = [
  {
    ...
    body: 'Bridge keeps your club searchable when students are actually looking for something to join.',
  },
  {
...
const SYSTEM_BLOCKS = [
  {
    ...
    body: 'Your club profile stays active in the Bridge directory with category, vibe, and current momentum so students can find you when interest is real, not just when they happen to walk by a table.',
    mock: 'directory',
  },
  {
    tag: 'Turnout',
...
function ClubRegistrationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4">
      ...
      <p className="text-center text-[11px] text-white/40">No spam. We only email about Bridge launch and club onboarding.</p>
    </form>
  )
}
      ...
      >
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-[1440px] gap-14 px-5 pb-16 pt-16 md:px-10 lg:grid-cols-[0.98fr_1.02fr] lg:px-16 lg:pt-24">
          <div className="max-w-[680px]">
            ...
            >
              Bridge gives clubs daily visibility, better turnout signals, and a cleaner operating surface.
        ...
        <div className="mx-auto flex max-w-[1400px] flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-xl tracking-[0.12em] text-white">BRIDGE</span>
            </div>
          ...
          <div className="flex flex-wrap gap-5 text-[11px] font-medium uppercase tracking-[0.12em] text-white/30">
            ...
            <a href="mailto:contactus@joinbridgeapp.com" className="no-underline transition-colors hover:text-white">Contact</a>
          </div>
        </div>
      </footer>
    </div>
